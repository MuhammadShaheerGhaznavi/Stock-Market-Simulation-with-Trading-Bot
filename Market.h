...
private:
    double initialPrice; // starting price of stock
    double volatility; // fluctuation 
    double expectedYearlyReturn; //return
    int numTradingDays; //num trading days to simulate -> size of prices array
